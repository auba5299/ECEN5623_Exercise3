...
#define READ_TIMEOUT_S (10) // timeout for pthread_mutex_timedlock in seconds
...
void *readThread(void *threadp)
{
    ...
    struct timespec abs_timeout;     // absolute timeout for pthread_mutex_timedlock
    int i = 0;                     // sequence counter
    int rc_m;                      // return code for mutex lock
